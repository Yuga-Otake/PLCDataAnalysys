...
# ツール定義（バージョン依存を避けるためプレーンdictで記述）
_FUNCTION_DECLARATIONS = [
    ...
    },
    {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "process_name": {"type": "string", "description": "工程名"},
                "step_name": {"type": "string", "description": "ステップ名"},
            },
...
APP_TOOLS = {"function_declarations": _FUNCTION_DECLARATIONS}
